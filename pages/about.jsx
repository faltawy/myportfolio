...
export default function About() {
  return (
    <>
      ...
      <div className="grid container mx-auto p-3 mt-5 lg:grid-cols-4 grid-cols-1 place-items-center justify-between gap-10 overflow-auto">
        ...
        <div className='h-[300px] col-span-2 w-[350px] sm:max-w-sm max-w-full relative group cursor-pointer'>
          ...
          <div className='relative h-full w-full overflow-hidden object-cover group rounded-[50px] hover:shadow-none transition-all'>
            ...
            <div className='h-auto w-full'>
              <Image src={'/images/myImage.jpg'} layout='fill' objectFit='cover' loading='lazy' objectPosition='center' alt='Ahmed Hassan' />
            </div>
          </div>
        </div>
        <p className='font-light col-span-2 text-start text-[18px] font-inter tracking-normal text-lightWhite leading-relaxed'>Hey There,<br /> Iam ahmed hassan Egyptian web developer <br /> based in zagazig city, iam self taught web developer spechilized in front-end design and development i started with html and css and little of js using alpine js and htmx then i migrated to reactjs and node </p>
