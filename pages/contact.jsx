...
function Contact() {
    return (
        <>
            ...
            <div style={{ minHeight: 'calc(100vh - 50px)' }} className='container text-white mx-auto p-2 mt-5'>
            ...
            <footer className='w-full z-10 h-[25px] fixed flex items-center justify-between p-1 bottom-0 left-0'>
