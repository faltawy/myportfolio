...
function Social({ icon, link, delay }) {
  return (
    <a href={link} style={{ animationDelay: delay,animationFillMode:'backwards' }} className="p-1 animate__animated animate__rotateIn text-darkBlue hover:bg-opacity-90 hover:-rotate-45 transition-all flex-center cursor-pointer w-[50px] h-[50px] bg-brand bg-opacity-60 rounded-full">
      {
    ...
    <div className="h-full flex-center p-3 container mx-auto overflow-auto">
      <div className="flex items-center gap-3 flex-col">
        <div className="myname opacity-0  animate__animated animate__fadeIn animate__slow">
          ...
          <h1 className="font-bold whitespace-nowrap leading-tight font-inter text-4xl text-lightWhite">Ahmed Hassan</h1>
          <span className="myname__sep"></span>
        </div>
        <p className="font-semibold text-2xl text-lightBlue">web developer</p>
